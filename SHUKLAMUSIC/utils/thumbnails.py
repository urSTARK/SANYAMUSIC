...
def crop_center_circle(img, output_size, border, crop_scale=0.6):
...
async def get_thumb(videoid: str) -> str:
    ...
    try:
        ...
        arial_font = ImageFont.truetype("SHUKLAMUSIC/assets/assets/font2.ttf", 30)
        regular_font = ImageFont.truetype("SHUKLAMUSIC/assets/assets/font.ttf", 30)
